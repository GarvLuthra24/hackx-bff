  ...
  return (
    <div className="Footer bg-red-600">
      <div className=" bg-gray-600 h-2/3 pt-10  text-white">
        <div className=" flex flex-row   h-4/5  justify-around max-w-5xl rounded-md p-5 dark:bg-gray-800 ml-auto mr-auto my-2">
        ...
        <footer class="bg-white rounded-lg shadow mt-10 dark:bg-gray-800 min-w-full pt">
          <div class="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
            ...
            <ul class="flex flex-wrap items-center mt-3 text-sm font-medium text-gray-500 dark:text-gray-400 sm:mt-0">
              ...
              <li>
                <a href="#" class="mr-4 mx-auto flex hover:underline md:mr-6 ">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    height="20"
              ...
              <li>
                <a href="#" class=" mx-auto flexhover:underline">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    height="20"
